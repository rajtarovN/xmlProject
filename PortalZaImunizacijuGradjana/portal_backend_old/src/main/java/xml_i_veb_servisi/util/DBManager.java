package main.java.xml_i_veb_servisi.util;
...
import main.java.xml_i_veb_servisi.model.digitalni_zeleni_sertifikat.DigitalniZeleniSertifikat;
import main.java.xml_i_veb_servisi.model.digitalni_zeleni_sertifikat.PrintDigitalniZeleniSertifikat;
import main.java.xml_i_veb_servisi.model.interesovanje.Interesovanje;
import main.java.xml_i_veb_servisi.model.interesovanje.PrintInteresovanje;
import main.java.xml_i_veb_servisi.model.izvestaj_o_imunizaciji.IzvestajOImunizaciji;
import main.java.xml_i_veb_servisi.model.izvestaj_o_imunizaciji.PrintIzvestajOImunizaciji;
import main.java.xml_i_veb_servisi.model.obrazac_saglasnosti_za_imunizaciju.Saglasnost;
import main.java.xml_i_veb_servisi.model.potvrda_o_vakcinaciji.PotvrdaOVakcinaciji;
import main.java.xml_i_veb_servisi.model.potvrda_o_vakcinaciji.PrintPotvrda;
import main.java.xml_i_veb_servisi.model.zahtev_za_sertifikatom.PrintZahtev;
import main.java.xml_i_veb_servisi.model.zahtev_za_sertifikatom.ZahtevZaZeleniSertifikat;
import main.java.xml_i_veb_servisi.model.obrazac_saglasnosti_za_imunizaciju.PrintSaglasnost;
import main.java.xml_i_veb_servisi.util.AuthenticationUtilities.ConnectionProperties;

import static main.java.xml_i_veb_servisi.util.PathConstants.*;
	...
	public static void saveToDb(String documentId, String type, ConnectionProperties conn) throws Exception {
		...
		try {
			...
			JAXBContext context = JAXBContext
					.newInstance("main.java.xml_i_veb_servisi.model." + type);
		...
		try {
			...
			if (res == null) {
				System.out.println("[WARNING] Document '" +  documentId + ".xml" + "' can not be found!");
				  ...
				  JAXBContext context =
				  JAXBContext.newInstance("main.java.xml_i_veb_servisi.model."+type);
