            ...
            <body>
                ...
                <div>
                    ...
                    <label>
                        ...
                        <xsl:value-of select="/Zahtev_za_zeleni_sertifikat/Podnosilac_zahteva/Prezime"/>
                    </label><br/>

                    <label>Датум рођења:</label>
                    <label>
                         <xsl:value-of select="/Zahtev_za_zeleni_sertifikat/Podnosilac_zahteva/Datum_rodjenja"/>
                    </label><br/>

                    <label>Пол:</label>
                    <label>
                         <xsl:value-of select="/Zahtev_za_zeleni_sertifikat/Podnosilac_zahteva/Pol"/>
                    </label><br/>

                    <label>Јединствени матични број грађанина:</label>
                    <label>
                        <xsl:value-of select="/Zahtev_za_zeleni_sertifikat/Podnosilac_zahteva/Jmbg"/>
                    </label><br/>

                    <label>Број пасоша:</label>
                    <label>
                        <xsl:value-of select="/Zahtev_za_zeleni_sertifikat/Podnosilac_zahteva/Broj_pasosa"/>
                    </label><br/>

                    <label>Разлог за подношење захтева:</label><br/>
                    <label>
                        <xsl:value-of select="/Zahtev_za_zeleni_sertifikat/Podnosilac_zahteva/Razlog_podnosenja_zahteva"/>
                    </label><br/>
                    <label class=" smallChar">(навести што прецизнији разлога за подношење захтева за издавање дигиталног пасоша)</label>
                    <br/><br/>
                    <label>
                        У <xsl:value-of select="/Zahtev_za_zeleni_sertifikat/Zaglavlje/Mesto_podnosenja_zahteva"/>
                    </label><br/>
                    <label>
